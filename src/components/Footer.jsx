    ...
    <footer className="mt-20 border-t py-10 border-slate-700">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <p className="text-slate-400 mb-4">{personalInfo.title}</p>
          <p className="text-slate-500 text-sm">{personalInfo.summary}</p>
        </div>
            ...
            {footerLinks.social.map((link, index) => (
              <li key={index}>
                <a
                  ...
                  className="text-slate-300 hover:text-blue-400 transition-colors duration-200 flex items-center gap-2"
                >
