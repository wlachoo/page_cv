    ...
    <div id="projects" className="relative mt-20 border-b border-slate-700 min-h-[600px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
        {projects.map((project, index) => (
          <div key={index} className="bg-slate-800/50 rounded-lg overflow-hidden border border-slate-700 hover:border-custom-primary transition-colors duration-300 group">
            <div className="aspect-video bg-slate-700 flex items-center justify-center">
              <Code className="w-16 h-16 text-white" />
            </div>
            
            <div className="p-6">
              <h3 className="text-xl font-semibold text-white mb-2 group-hover:text-custom-primary transition-colors">
                {project.name}
              </h3>
              ...
              <div className="mb-4">
                ...
                <ul className="space-y-1">
                  {project.features.map((feature, featIndex) => (
                    <li key={featIndex} className="text-white text-sm flex items-start gap-2">
              ...
              <div className="flex gap-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-white hover:text-custom-primary transition-colors text-sm"
                >
